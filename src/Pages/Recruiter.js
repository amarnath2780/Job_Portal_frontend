  ...
  return (
    <div className='recruiter' style={{background:"#fff"}}>
      ...
      <div className='posted' >
        {profile.is_requested ? <p style={{color: '#000' }}>'You request is pending'</p> : profile.is_acceped ? <div>
        <p style={{color: '#000'}}>'You can add Job Now  <Link style={{color: '#000'}}  to='/post-job'>Here</Link>
        </p>
